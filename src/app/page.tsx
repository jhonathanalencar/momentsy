...
export default function Home() {
  return (
    <section className="grid flex-1 grid-cols-2 bg-momentsy-gray-900 text-momentsy-gray-400">
      <div className="relative overflow-hidden bg-[url('../assets/bg-stars.svg')] px-4 py-8 md:px-8">
        <div className="mx-auto flex h-full w-full max-w-[600px] flex-col items-center justify-center">
          <div className="my-auto flex w-full flex-col gap-2">
            <span className="w-full text-5xl font-bold text-momentsy-beige">
              Momentsy
            </span>
            <h1 className="text-4xl font-semibold text-momentsy-gray-100">
              Sua história está aqui
            </h1>
            <p className="text-lg font-medium leading-snug tracking-wide text-momentsy-gray-400">
              Colecione e relembre momentos marcantes e especiais de sua vida e
              compartilhe (se quiser) com o mundo!
            </p>
            <button className="mt-6 flex w-fit items-center gap-2 rounded-md bg-[#EA4335] px-3 py-2 font-semibold text-momentsy-gray-100 shadow-sm transition-colors hover:bg-[#f65314]">
